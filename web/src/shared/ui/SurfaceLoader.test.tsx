...
describe("SurfaceLoader", () => {
  it("renders the branded console contract for panel loading states", () => {
    const { container } = render(<SurfaceLoader message="Preparing workspace skin." title="Applying theme" />);
    ...
    expect(container.querySelector(".surface-loader__rabbit")).not.toBeNull();
  });
});
